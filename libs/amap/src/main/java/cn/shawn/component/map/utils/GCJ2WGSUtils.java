package cn.shawn.component.map.utils;

import com.amap.api.maps.model.LatLng;

public class GCJ2WGSUtils {

    public static LatLng convertToWGSLat(LatLng latLng) {
        return new LatLng(WGSLat(latLng.latitude, latLng.longitude),
                WGSLon(latLng.latitude, latLng.longitude));
    }
